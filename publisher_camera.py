...
node = nep.node('camera_web_py')
#conf = node.direct(ip = "192.168.1.6", port = 3000, mode="one2many") 
conf = node.hybrid("192.168.0.101") # change the IP displayed when using nep master wifi
pub_image = node.new_pub('test_image','image',conf)
